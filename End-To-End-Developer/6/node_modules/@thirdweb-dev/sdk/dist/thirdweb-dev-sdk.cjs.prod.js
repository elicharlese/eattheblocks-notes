...
var ABI$b = require('@thirdweb-dev/contracts-js/dist/abis/Multiwrap.json');
var ABI$4 = require('@thirdweb-dev/contracts-js/dist/abis/DropERC20.json');
var ContractPublisherAbi = require('@thirdweb-dev/contracts-js/dist/abis/ContractPublisher.json');
var ABI$9 = require('@thirdweb-dev/contracts-js/dist/abis/DropERC721.json');
var ABI$a = require('@thirdweb-dev/contracts-js/dist/abis/SignatureDrop.json');
var ABI = require('@thirdweb-dev/contracts-js/dist/abis/TokenERC721.json');
var ABI$1 = require('@thirdweb-dev/contracts-js/dist/abis/DropERC1155.json');
var ABI$2 = require('@thirdweb-dev/contracts-js/dist/abis/TokenERC1155.json');
var ABI$3 = require('@thirdweb-dev/contracts-js/dist/abis/TokenERC20.json');
var ABI$5 = require('@thirdweb-dev/contracts-js/dist/abis/VoteERC20.json');
var ABI$6 = require('@thirdweb-dev/contracts-js/dist/abis/Split.json');
var ABI$7 = require('@thirdweb-dev/contracts-js/dist/abis/Marketplace.json');
var ABI$8 = require('@thirdweb-dev/contracts-js/dist/abis/Pack.json');
...
_defineProperty(NFTCollection, "contractAbi", ABI__default["default"]);
...
_defineProperty(Edition, "contractAbi", ABI__default$2["default"]);
...
_defineProperty(Token, "contractAbi", ABI__default$3["default"]);
...
_defineProperty(TokenDrop, "contractAbi", ABI__default$4["default"]);
...
_defineProperty(Vote, "contractAbi", ABI__default$5["default"]);
...
_defineProperty(Split, "contractAbi", ABI__default$6["default"]);
...
_defineProperty(Marketplace, "contractAbi", ABI__default$7["default"]);
...
_defineProperty(Pack, "contractAbi", ABI__default$8["default"]);
...
_defineProperty(NFTDrop, "contractAbi", ABI__default$9["default"]);
...
_defineProperty(SignatureDrop, "contractAbi", ABI__default$a["default"]);
...
_defineProperty(Multiwrap, "contractAbi", ABI__default$b["default"]);
