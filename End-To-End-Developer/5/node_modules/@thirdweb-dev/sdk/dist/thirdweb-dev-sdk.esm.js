...
import { Forwarder__factory, IERC20__factory, IThirdwebContract__factory, TWFactory__factory, TWRegistry__factory } from '@thirdweb-dev/contracts-js';
import ERC20MetadataAbi from '@thirdweb-dev/contracts-js/dist/abis/IERC20Metadata.json';
import MerkleTree from 'merkletreejs';
import deepEqual from 'fast-deep-equal';
import ABI$b from '@thirdweb-dev/contracts-js/dist/abis/Multiwrap.json';
import ABI$4 from '@thirdweb-dev/contracts-js/dist/abis/DropERC20.json';
import ContractPublisherAbi from '@thirdweb-dev/contracts-js/dist/abis/ContractPublisher.json';
import ABI$9 from '@thirdweb-dev/contracts-js/dist/abis/DropERC721.json';
import ABI$a from '@thirdweb-dev/contracts-js/dist/abis/SignatureDrop.json';
...
import ABI$2 from '@thirdweb-dev/contracts-js/dist/abis/TokenERC1155.json';
import ABI$3 from '@thirdweb-dev/contracts-js/dist/abis/TokenERC20.json';
import ABI$5 from '@thirdweb-dev/contracts-js/dist/abis/VoteERC20.json';
import ABI$6 from '@thirdweb-dev/contracts-js/dist/abis/Split.json';
import ABI$7 from '@thirdweb-dev/contracts-js/dist/abis/Marketplace.json';
import ABI$8 from '@thirdweb-dev/contracts-js/dist/abis/Pack.json';
...
const DEFAULT_API_KEY = "f5db7c96b2131bfe3a36c6a3fcf9a3b8c88137112d94c9d5658b57db92aac1cf";
function getRpcUrl(network) {
  return "https://".concat(network, ".rpc.thirdweb.com/").concat(DEFAULT_API_KEY);
}
/**
 * @internal
...
_defineProperty(NFTCollection, "contractAbi", ABI);
...
_defineProperty(Edition, "contractAbi", ABI$2);
...
_defineProperty(Token, "contractAbi", ABI$3);
...
_defineProperty(TokenDrop, "contractAbi", ABI$4);
...
_defineProperty(Vote, "contractAbi", ABI$5);
...
_defineProperty(Split, "contractAbi", ABI$6);
...
_defineProperty(Marketplace, "contractAbi", ABI$7);
...
_defineProperty(Pack, "contractAbi", ABI$8);
...
_defineProperty(NFTDrop, "contractAbi", ABI$9);
...
_defineProperty(SignatureDrop, "contractAbi", ABI$a);
...
_defineProperty(Multiwrap, "contractAbi", ABI$b);
